...
Welcome to my [personal website](https://tejasva-bhatia.netlify.app/)! This is an React-based Jamstack application. 
...
1. Clone the repository:
    ...
    ```bash
    git clone git@github.com:Tejasva-Bhatia/personal-website.git
    cd personal-wesite
    ```
